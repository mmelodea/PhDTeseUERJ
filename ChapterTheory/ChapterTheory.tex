...
\begin{figure}[htbp]{15cm}
	...
	\subfloat[Gluon fusion]{\includegraphics[scale=0.3]{ChapterTheory/figs/ggH.png}}
	\subfloat[Vector boson fusion]{\includegraphics[scale=0.3]{ChapterTheory/figs/VBF.png}}
	\subfloat[Higgs-strahlung]{\includegraphics[scale=0.3]{ChapterTheory/figs/AssWZ.png}}
	\subfloat[Associated production with top quark]{\includegraphics[scale=0.3]{ChapterTheory/figs/Ass_tt.png}}
