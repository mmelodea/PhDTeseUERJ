...
\begin{folhadeaprovacao}
  ...
  \assinatura{Prof. Dr. Helena Brandão Malbouisson}{Universidade do Estado do Rio de Janeiro - UERJ}
...
\include{ChapterTheory/ChapterTheory}
\include{ChapterCMS/ChapterCMS}
\include{ChapterAnalysis/ChapterAnalysis}
\include{Conclusion}
%=============================================================
...
\appendix
%=============================================================
\include{AppendixNeuralNetwork/AppendixNeuralNetwork}
\include{ChapterAnalysis/AppendixEventDisplay}
\include{ChapterAnalysis/AppendixFinalNNsArchitecture}
\include{AppendixCMSL1TT/AppendixCMSL1TT}
\include{AppendixFastME/AppendixFastME}
\include{AppendixGlobalDocProject/AppendixGlobalDocProject}
%=============================================================
