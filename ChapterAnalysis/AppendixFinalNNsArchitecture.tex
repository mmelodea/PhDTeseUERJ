\postextualchapter{Final ANN Architectures}
...
\postextualchapter{ANNs Expected $S/\sqrt{B}$ and $\pi~.~S/(S+B)$}
\label{app:significance_cutting_NNs}

\begin{figure}[H!]{16cm}
	\vspace{-20cm}
	\caption{The performance of the final ANNs.}
