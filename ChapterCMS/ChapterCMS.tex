...
\source{Adapted from \cite{bib:Nature-448-2017}, p. 286.}
\label{fig:lhc_cs}
\end{figure}
...
\hline \hline
\end{tabular}
\source{Reference \cite{bib:lhc-guide}, p. 5.}
...
\source{Reference \cite{bib:lhc-guide}, p. 13.}
\label{fig:LHC_parts}
\end{figure}
...
\source{Reference \cite{bib:CMS-PTDR-2006}, p. 5.}
\label{fig:cms_fig1}
\end{figure}
...
\begin{figure}[htbp]{16cm}
	...
	\source{Reference \cite{bib:cms-page}.}
	\label{fig:cms_fig2}
\end{figure}
...
\source{Reference \cite{bib:CMS-PTDR-2006}, p. 20.}
...
\source{Reference \cite{bib:JINST-3-362-2008}, p. 125.}
\label{fig:hcal_hb}
\end{figure}
...
\source{Reference \cite{bib:JINST-3-362-2008}, p. 131.}
\label{fig:hcal_he}
\end{figure}
...
\source{Reference \cite{bib:JINST-3-362-2008}, p. 138 e 140.}
\label{fig:hcal_ho}
...
\begin{figure}[htbp]{15cm}
	...
	\source{Reference \cite{bib:hcal-tdr-1997}, p. 138 e 140.}
	\label{fig:hcal_hf}
\end{figure}
...
\source{Reference \cite{bib:JINST-3-362-2008} p. 7.}
...
\source{Reference \cite{bib:CMS-PTDR-2006}, p. 11 and 12.}
...
\end{multicols}
\source{Reference \cite{bib:JINST-3-362-2008}, p. 169 and \cite{bib:CMS-PTDR-2006}, p. 94.}
