...
\begin{figure}[htbp]{15cm}
\caption{Scheme of the positions of HO in the muon detection system and its effect on the measurement of the energy from hadronic showers.}
\subfloat[]{\includegraphics[scale=0.7]{ChapterCMS/figs/hcal_ho.png}} \hspace{0.5cm}
\subfloat[]{\includegraphics[scale=0.6]{ChapterCMS/figs/ho_sim.png}}
\legend{(a) HO transverse section; (b) HO effect on the balance of energy measured in the CMS}
...
\subfloat[]{\includegraphics[scale=0.5]{ChapterCMS/figs/solenoid.png}}\quad
\subfloat[]{\includegraphics[scale=0.65]{ChapterCMS/figs/cms_magnetic_field_map}}
\legend{(a) scheme of the CMS solenoid; (b) mapping of the magnetic field created by the solenoid.}
...
\begin{figure}[htbp]{16cm}
\caption{Detection system for muons and its performance.}
\centering
\subfloat[]{\includegraphics[scale=0.6]{ChapterCMS/figs/pmu_reso.png}}\\
\subfloat[]{\includegraphics[scale=0.6]{ChapterCMS/figs/sist_muon_position.png}}
\legend{(a) location of the muon chambers in a section of the CMS detector; (b) resolutions on the measruement of the muons transverse momentum. The combination of the muon chambers and the tracker increases the resolution on the $p_{T}$ measurement.}
...
\begin{multicols}{2}
\subfloat[]{\includegraphics[scale=0.23]{ChapterCMS/figs/dtc.png}}\\
\subfloat[]{\includegraphics[scale=0.44]{ChapterCMS/figs/rpc.jpg}}\\
\subfloat[]{\includegraphics[height=7cm,width=5.5cm]{ChapterCMS/figs/csc.png}}
\end{multicols}
